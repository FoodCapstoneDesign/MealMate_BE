...
enum class ErrorCode(
    ...
    NOT_EXIST_MEMBER(HttpStatusCode.BAD_REQUEST.status,"존재하지 않는 멤버입니다"),
    NOT_EXIST_ADMIN(HttpStatusCode.BAD_REQUEST.status, "존재하지 않는 관리자입니다!"),
    ...
    NOT_EXIST_RESTAURANT_MENU(HttpStatusCode.BAD_REQUEST.status, "존재하지 않는 메뉴입니다!"),
    ...
    EXIST_RESTAURANT(HttpStatusCode.BAD_REQUEST.status,"이미 존재하는 식당입니다!")
